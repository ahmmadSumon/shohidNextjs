import { notFound } from 'next/navigation'; // Import this to handle 404
import Image from 'next/image';
import img from '../../../public/image/syd.png'; // Adjust the path as needed
...
const StoryPage = ({ params }) => {
  ...
  // If story is not found, show a 404 page
  if (!story) {
    return notFound();
  }
